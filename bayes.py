...
class ParzenBayes(Bayes,D_Parzen):
    ...
    def plot_test(self):
        ...
        ax.set_ylabel('Y')
        ax.set_xlabel('X')
        plt.savefig(str(self.name + "pw.png"))
        # plt.show()
    ...
    def plot_data(self):
        ...
        plt.savefig(str(self.name + "pw1.png"))
        # plt.show()
    ...
    def get_parameter_by_cross_validate(self, folds_n, training_data):
        ...
        # 绘制数据点
        plt.savefig(str(self.name+"pw2.png"))
...
if __name__ == "__main__":
    ...
    # data_set.importdata(url=data_url, index_col=3, index_name=attribute_information, usecol=usecol,header=0)
